...
public class TaiwanPropPriceBuilder extends AbstractPropPriceBuilder {
    private static final String TARGET_REGION_CODE = "TW";
    private static final String TARGET_REGION_NAME = "台服";
    private static final String COST_REGION_CODE = "VNM";
    private static final Double DISCOUNT_POINT = 0.9;
