...
public class JapanPropPriceBuilder extends AbstractPropPriceBuilder {
    private static final String TARGET_REGION_CODE = "JP";
    private static final String TARGET_REGION_NAME = "日服";
