package org.bluebridge.byte_stream._06_filter_io_stream._02_data_io_stream;
 ...
 */
@Slf4j(topic = "·")
public class DataInputStreamOutputStreamTest {

    @Test
    public void testDataInputStream() {
        try(DataOutputStream dos = new DataOutputStream(new FileOutputStream("d:/dataoutputstream.txt"));
