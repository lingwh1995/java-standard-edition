![image-20221026154454258](.\images\Mu6qwoA9fc7THbQ.png)
...
![image-20221026164200924](.\images\fMQDFCmyqIvJeTl.png)
...
![image-20221026165600076](.\images\ZSQs1NhWlJeyMmi.png)
...
![image-20221026170449235](.\images\CknumyFjpz659Ya.png)
...
![image-20221027151713661](.\images\drC1nx2NSK9Ewaf.png)
...
![image-20221027161611050](.\images\DAz1hnUekV6RNqd.png)
...
![image-20221027155830335](.\images\IiwomHF7YWe8Vuh.png)
...
![image-20221027164500070](.\images\VQm7FjSNidLhI1r.png)
...
![image-20221027170224462](.\images\D6hslN2pHybmVdF.png)
...
![image-20221027175842110](.\images\VjCdNbAUIi5R61Z.png)
...
![image-20221027181909908](.\images\Fsj8PqHryUYdgeC.png)
...
![image-20221027182010485](.\images\zy4L2T67rGQe3HI.png)
...
![image-20221027183745934](.\images\R5cDrYxoKtpCJk6.png)
...
![image-20221027182903783](.\images\gArLdNTI1ClWh5K.png)
...
![image-20221027184138604](.\images\ZhpojvR6u5DTmVP.png)
...
![image-20221027184618359](.\images\7re3aBis2jW9wvP.png)

![image-20221027184627653](.\images\Erb6npLZqsCPGzQ.png)
...
![image-20221027184814288](.\images\Er4wqYUNfAy2HBS.png)
...
![image-20221027185748324](.\images\pErwuKAGOa3dQ5l.png)
...
![image-20221027190207441](.\images\y8713x9VBlCaQm6.png)
...
![image-20221028135701447](.\images\ro7Cxi5Oe8wuALv.png)
...
![image-20221028140816161](.\images\ZigtAkDbrMVqjWz.png)
...
![image-20221028143042506](.\images\XQqnd6GHa7hVOtR.png)
...
![image-20221028142144585](.\images\471ED3GaefjzHy8.png)

当我们对窗口大小进行调整时，流式布局也会进行自动调整：

![image-20221028142326191](.\images\hJrBtcVj7MDGqfw.png)
...
![image-20221028142506961](.\images\QlU8IPoVA2j4E6t.png)
...
![image-20221028145118733](.\images\joR1s467rFzJqOE.png)
...
![image-20221028145330522](.\images\DtnRaCJh7qzc4w3.png)
...
![image-20221028145752545](.\images\JNmjEVWIG2nkxbf.png)
...
![image-20221028151242522](.\images\9ZfvOxThctdPS6N.png)
...
![image-20221028151701189](.\images\jVGTNmd3i2ZRg5h.png)

![image-20221028151845514](.\images\6PGem8qMrV7NOZS.png)
...
![image-20221028152352861](.\images\agMjZkqrSGUm9Ld.png)
...
![image-20221028152617119](.\images\RbiFpTDCEaN5fPl.png)
...
![image-20221028153201386](.\images\7mKakMLhz95VbIp.png)
...
![image-20221028155050727](.\images\ZDa92CJVf7TbGk4.png)
...
![image-20221028155443331](.\images\SQZapDy6vdLkHNx.png)
...
![image-20221028160340931](.\images\ieDtpQqdkBzhsKF.png)
...
![image-20221028160611113](.\images\LXIvYhnFVBlQTGt.png)
...
![image-20221028161209224](.\images\Konar26QHWMTwqd.png)

在MacOS下是整合到状态栏中的：

![image-20221028161239672](.\images\G3NiRaBMkJLneVl.png)

这些菜单一般都会包含我们程序中的一些基本操作，实际上我们的程序中很多地方都会使用到下拉菜单：

![image-20221028161118028](.\images\hc354p1ri6NmGgA.png)
...
![image-20221028161741397](.\images\wIWdRo2velTj1VS.png)

虽然有点丑，但是确实是内味，不过还是MacOS下好看：

![image-20221028161910928](.\images\7Dq6L1hbreYIy39.png)
...
![image-20221028162602244](.\images\KskDE9J2QdRtlvV.png)
...
![image-20221030173320786](.\images\lwrjgRxu46UXHZk.png)
...
![image-20221028162655033](.\images\Q1RgUn7ejZXzH5E.png)

实际上要添加这样的菜单栏还是挺简单的的，我们接着来看弹出菜单，弹出菜单其实也经常出现，比如我们要新建一个类，我们就可以右键对应的包：

![image-20221028214019648](.\images\IKe1NL5wm834WdP.png)
...
![image-20221028215651667](.\images\tMRbdjE6ZhHuPaQ.png)
...
![image-20221028220721666](.\images\VUshJzZXxC51gpb.png)
...
![image-20221028223431754](.\images\VmajcUlSD6GPsrv.png)
...
![image-20221028224410637](.\images\3v7ZJio9mMnK8zk.png)
...
![image-20221028224815769](.\images\TuHNLsmokZvMhIR.png)
...
![image-20221028225343739](.\images\uRjWKPgFxCcGUvr.png)
...
![image-20221028232701565](.\images\qQweM6DprRJjCl7.png)
...
![image-20221028233307877](.\images\xBsuijLa6beOwJy.png)
...
![image-20221028235756338](.\images\5adDsGr2iRxywCX.png)
...
![image-20221029111107959](.\images\u9jSlmAc2GXr4VJ.png)
...
![image-20221029111439062](.\images\areQf2g3I74mlpV.png)
...
![image-20221029112035219](.\images\hQ2YLjSgazM9Wkd.png)
...
![image-20221029120313940](.\images\dy6R2VNuOYIJamA.png)
...
![image-20221105171035570](.\images\RMJWl576CiSDs8b.png)
...
![image-20221029120737715](.\images\aMGHTu8sl2Sg4vm.png)
...
![image-20221105163846233](.\images\SY8wjEkdcArvxnQ.png)
...
![image-20221105165756172](.\images\qNoT6OwylH4Y8xc.png)
...
![image-20221105170052200](.\images\1fBdjMOy4SnADHu.png)

它有着两个状态，我们点击一次会使得其切换到另一种状态：

![image-20221105170125623](.\images\JXpw64yHb8rCRSg.png)
...
![image-20221105170623359](.\images\zsjxuSoYEr9lvZy.png)

这个太高级了，看着就很专业。同样的还有文件选择器JFileChooser：

![image-20221105170745920](.\images\T6Vld1NMB9AJfct.png)

完了，这Mac越用咋越像Windows了。

当然，Swing考虑得不止这些，甚至连工具提示都有，啥是工具提示？

![image-20221105171336948](.\images\mGaU6X2ILvqQT1g.png)
...
![image-20221105171453445](.\images\izpvcCbVA3Ut81u.png)

`setToolTipText`方法是`JComponent`就带有的，因此任何组件都可以设置这样的工具提示，是不是感觉很高级？

还有文件树，我们经常在窗口中看到这样的：

![image-20221105171728838](.\images\gcCnLterFaqPvkK.png)
...
![image-20221105171813979](.\images\IvjYykGRXiOAMtK.png)
...
![image-20221105172802572](.\images\YN4gKJbfstpRSCE.png)
...
![image-20221105173345221](.\images\keDg2pnsJolaUZH.png)
...
![image-20221105173821177](.\images\4jp1N9LnmwJGtOl.png)
...
![image-20221105174105955](.\images\QBPn8lk9tFd6sgH.png)

除了多面板这样的特殊面板组件之外，我们也可以使用分割面板：

![image-20221105174239436](.\images\2gMxOrFGkHCJ73o.png)

分割面板将一块完整的面板分割为两个部分，这样，我们就可以分别在左右两边进行操作了，而且中间的分割线是可以拖动的，实际上我们的IDEA也是这样的：

![image-20221105174326135](.\images\21l4GHg75fCaFzP.png)
...
![image-20221105174609500](.\images\3VjoCckOZG2qNIf.png)
...
![image-20221105180609195](.\images\rwik4EqaOeMYWfz.png)
...
![image-20221106162732123](.\images\ekOZLQnUR2dMXTN.png)
...
![image-20221106165351473](.\images\YH8dgDRunsG9jPv.png)
...
![image-20221106165324954](.\images\ZwGfv1HqOjikEPn.png)
...
![image-20221106170921703](.\images\L7HyUlVpA5P9iTZ.png)

是不是感觉视觉上和之前的皮肤不太一样？我们可以多看看其他的皮肤：

![image-20221106171046755](.\images\EGrWzIZuRfejXN2.png)

![image-20221106171110930](.\images\BOtWrIe7CuklMcZ.png)
...
![image-20221106224348544](.\images\2NChELXRkoqJGMQ.png)
...
![image-20221106231437842](.\images\53kHx2zTZ7wtUfC.png)
